% about "categories and sheaves" (version awy)
...
As mentioned in \S\ref{225} p.~\pageref{225}, on line 3 of p.~225 ``Since $N_s$ is a subobject of $A$ and $\card(A(G))<\pi$'' should be ``Since $\card(A(G))<\pi$'', and on line~4 of p.~225 ``there exists $i_0\to i_1$ such that $N_{i_1}\to A$ is an epimorphism'' should be ``there exists $s:i_0\to i$ such that $N_s\to A$ is an epimorphism''.
