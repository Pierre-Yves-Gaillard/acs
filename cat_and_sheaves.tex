% about "categories and sheaves" (version_0153)
...
Also note that the functors $\psi^\dagger(\pp\circ\psi)$ and $\pp^\dagger(\pp)$ exist and are respectively isomorphic to $\pp$ and $\id_I$. 
\end{s}
