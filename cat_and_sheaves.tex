...
It remains to prove Steps 3, 3', 4, 5 and 6. %We refer to the book for Step 3. The proof of Step 3' is the same.  

\begin{proof}[Proof of Step 3]
In Step (iii) of the proof of Theorem 5.3.6 p. 124 in the book, an isomorphism 
$$
\col_i\Coim z_i\xr\sim\Coim\left(\col_i\zeta(z_i)\to X\right)
$$ 
is constructed. It is easy but tedious to check that this isomorphism coincides with the natural morphism. 
\end{proof} 

\begin{proof}[Proof of Step 3'] 
The statement of Step 3' is a generalization of the statement of Step 3, and it is not hard to generalize the proof of Step 3 to Step 3'. (By \S\ref{sbbc} p.~\pr{sbbc} small inductive limits in $\F^\wg$ are stable by base change --- Definition 2.2.6 p.~47 of the book, stated above as Definition~\ref{dsbc} p.~\pr{dsbc}.) 
\end{proof} 
