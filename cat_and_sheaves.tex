% about "categories and sheaves" (version_0066)
...
\nn[\S\ref{le} p.~\pageref{le} will be inserted here.]
...
\begin{s}\label{le}% Jan 21, 2014
P. 391, Chapter 16, notion of {\em local epimorphism}. \index{local epimorphism} I don't think GT4 follows from LE1-LE4. I suggest to replace LE1-LE4 with LE1-LE5, where LE5 is defined as follows:

\nn LE5: If $A\to U$ is a morphism in $\C^\wedge$ with $U$ in $\C$, if $S$ is a covering sieve over $U$, and if $A\times_UV\to V$ is a local epimorphism for all morphism $V\to U$ in $S$, then $A\to U$ is a local epimorphism.

I think the proofs involving the notion of local epimorphism could be easily adjusted to this new definition. 
\end{s}
