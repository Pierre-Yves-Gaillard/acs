...
satisfy 
$$
\Hom_{\oo D(\C)}(X,Y)\simeq H^0R(\Hom_\C^\bu)(X,Y)\simeq 
$$

$$
\simeq H^0R(\Hom_\C^\bu(X,\ \ ))(Y)\simeq H^0R(\Hom_\C^\bu(\ \ ,Y))(X)
$$

$$
\simeq R(\Hom_{\oo K(\C)})(X,Y)\simeq R(\Hom_{\oo K(\C)}(X,\ \ ))(Y)\simeq R(\Hom_{\oo K(\C)}(\ \ ,Y))(X).
$$ 
(In the last line, we use Notation 10.3.8 p.~255 of the book.) This implies 
$$
