% about "categories and sheaves" (version-0218)
...
\nn(i) $A$ is in $\Ind^\pi(\C)$, 

\nn(ii) for any category $J$ such that $\card(\Mor(J))<\pi$ and any functor $\pp:J\to\C$, the natural map 
$$
A(\colim\pp)\to\lim A(\pp)
$$ 
is surjective. 
