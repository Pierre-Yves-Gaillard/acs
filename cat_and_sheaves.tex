...
We shall use implicitly, not only the statements of the bijections \qr{fyx'1} and \qr{fyx'2}, but also their proofs. 
...
\begin{up}
Step~(i), Line~4: I don't know why $K^{\op}$ is cofinally small. 
