...
\begin{s}\lb{731} 
P. 159, Lemma 7.3.1 (i). The claim is that, in terms of \S\ref{s232} (a) p.~\pr{s232}, there is some $\tau:F\to R_\SSS F\ci Q$ such that the pair $(Q^\dg F,\tau)$ co-represents the functor 
$$
