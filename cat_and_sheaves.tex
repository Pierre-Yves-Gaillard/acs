% about "categories and sheaves" (version auh)
...
%
\begin{proof}
Exactness at $V$: Let $V\to T$ be a morphism. By \S\ref{8312} p.~\pageref{8312} it suffices to show that the diagram of solid arrows 
$$
\begin{tikzcd}
...
\nn Exactness at $U$: Let $U\to T$ be a morphism whose composition with $V\to U$ is zero. By \S\ref{8312} p.~\pageref{8312} it suffices to show that the commutative the diagram of solid arrows 
$$
\begin{tikzcd}
...
\end{tikzcd}
$$ 
can be completed as indicated. This follows from the fact that, again by \S\ref{8312} p.~\pageref{8312}, the commutative diagram of solid arrows 
$$
\begin{tikzcd}
...
\nn Exactness at $W$: Let $T\to W$ be a morphism. By Lemma 8.3.12 p.~180 of the book, it suffices to show that the diagram of solid arrows 
$$
\begin{tikzcd}
...
\end{tikzcd}
$$ 
can be completed to a commutative diagram as indicated. This follows from the fact that, again by Lemma 8.3.12 p.~180 of the book, the commutative diagram of solid arrows 
$$
\begin{tikzcd}
S\ar[dashed,two heads]{r}\ar[dashed]{d}&T\ar{d}\\ 
X\ar{r}&W
