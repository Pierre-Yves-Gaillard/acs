% about "categories and sheaves" (version_0067)
...
\begin{s}\label{gt}% Jan 21, 2014
P. 390, Definition of a {\em Grothendieck topology}. \index{Grothendieck topology} 
Being unable to derive GT4 from LE1-LE4, I suggest to replace GT4 in Definition 16.1.2 p.~390 of the book with 
...
I think that GT1, GT2, GT3 and GT4' are equivalent with LE1-LE4, that is, the datum of a Grothendieck topology in this nonstandard sense is equivalent to the datum of a set of  morphisms satisfying LE1-LE4.

This nonstandard definition of a Grothendieck topology is {\em a priori} more general than the standard one. 
\end{s}
