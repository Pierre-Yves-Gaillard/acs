...
\end{prop}
\begin{proof}
Let $F$ be in $\C''$ and $G$ in $\C'$, and consider the equalities 
$$
...
$$
The last equality follows from Lemma 8.2.11, and the others are straightforward.
\end{proof} 
\end{s}
...
$$ 
holds. This inclusion follows from Propositions 3.3.3 p.~82 (see Proposition~\ref{333} p.~\pr{333}), 6.1.7 p.~132, 8.2.13 p.~173 (see \S\ref{8211} p.~\pr{8211}) 8.2.15 p.~173 in the book.
\end{s}
...
\begin{center}\fbox{Small filtrant colimits exist and in $\SSS^{\wg,prod}$ and are exact.}\end{center}\bigskip
\end{s}
