...
$$ 
Let $b_1,b_2,b_3,b_4$ be in $B$. We must check that the pentagone build from $b_1$, $b_2$, $b_3$, $b_4$ commutes. 
...
\end{tikzcd}
$$ 
(All the morphisms under consideration being isomorphisms, it is not necessary to orient the edges.) The argument is this: Assuming that all the quadrilaterals commute, if one of the pentagones commutes, so does the other.
\end{s} 
