% about "categories and sheaves" (version_0043)
...
\begin{df}\label{uil}
If the natural map $\co\Hom_\C(Y,\alpha)\to\Hom_\C(Y,X)$ is bijective for all $Y$ in $\C$, we say that $X$ is a {\em universal} inductive limit \index{universal inductive limit} of $\alpha$.
\end{df}
