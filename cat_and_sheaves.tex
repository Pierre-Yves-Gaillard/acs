% about "categories and sheaves" (version avj)
...
%
\begin{proof}
We assume, as we may, that $I$ is nonempty, well-ordered, and admits a maximum $m$. We shall achieve the following Task $(T_i)$ by transfinite induction on $i\in I$: 
...
X'\ar{r}[swap]{v_j}&Y'_{<j}\ar{r}[swap]{w_j}&Y'_k,\ar{ul}[swap]{p_{ij}}
\end{tikzcd}
$$
...
Let $0$ be the least element of $I$. To achieve Task $(T_0)$, let us define $Y'_0,v_0$, and $h_0$ by (9.5.2) (ii):
$$
\begin{tikzcd}
...
Task $(T_i)$ has been achieved for the specific $i$ we have been considering, and thus Task $(T_i)$ has been achieved for all $i$ in $I$. In particular Task $(T_m)$, where, remember, $m$ is the maximum of $I$, has also been achieved. Putting $Y':=Y'_m$ and 
$$
