...
\nn where (a) follows from \eqref{263a} p.~\pageref{263a}; (b) is obvious; (c) follows from Proposition~\ref{271} and \eqref{leq}, \eqref{lcom}; and (d) follows from Proposition~\ref{271}. A similar computation shows 
$$
