% about "categories and sheaves" (version_0053)
...
p_{ik}\circ w_k\circ v_k=v_i,
\end{equation}
\begin{equation}\label{pijwj}
p_{ij}\circ w_j\circ p_{jk}=p_{ik}.
\end{equation} 
The commutativity of \eqref{hiui1} implies \eqref{hiui2}. We have 
$$
v_k=p_{k0}\circ w_0\circ v_0=p_{k0}\circ v_0,
$$
$$
p_{ik}\circ w_k\circ v_k=p_{ik}\circ w_k\circ p_{k0}\circ v_0=p_{i0}\circ v_0=v_i.
$$ 
This proves \eqref{pikwk}. We have 
$$
p_{ij}\circ w_j\circ p_{jk}=p_{ij}\circ u_{jk}=p_{ik}.
$$ 
