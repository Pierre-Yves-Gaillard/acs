% about "categories and sheaves" (version avt)
...
We recall the notion of {\em construction by transfinite induction}. We recall it first in the setting of Bourbaki's set theory, to which, as already mentioned, we adhere. Then we shall phrase this concept in a way which does not involve explicitly Bourbaki's set theory (see Metatheorem~\ref{meta2} below). For any element $i$ of any ordered set $I$ we freely use the self-explanatory pieces of notation $I_{<i}$ and $I_{\le i}$. 
