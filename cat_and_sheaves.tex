% about "categories and sheaves" (version_0082)
...
\begin{s} 
P. 398, Lemma 16.2.7. I don't understand why $\cc{LI}_A$ admits finite projective limits. The fact that $\cc{LI}_A$ is cofiltrant follows from Lemma 16.2.4 (i) p.~395 of the book and Display~\eqref{e1623} p.~\pageref{e1623}. It seems to me that only the fact that $\cc{LI}_A$ is cofiltrant is used in the sequel.
\end{s}
