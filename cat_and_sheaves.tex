% about "categories and sheaves" (version auv)
...
\nn(Since the set of quotients of $G^{\coprod A}$ is small if $\card(A)<\pi_0$, such a cardinal $\pi_1$ exists.) In the sequel of Subsection~\ref{s934} we assume 
%
