...
More precisely, if $\iota:\SSS^{\wg,prod}\to\SSS^\wg$ is the natural functor, then the proof of Lemma 10.5.7 (ii) in the book shows, in the notation used there, that $\oplus_i\,\iota F_i$ is isomorphic to $\iota\Coker(\pp(\oplus_iX_i)\to\pp(\oplus_iY_i))$. 
