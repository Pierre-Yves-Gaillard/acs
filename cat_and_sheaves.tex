% about "categories and sheaves" (version_0123)
...
\begin{s}
P. 413. Lemma 17.2.5 (ii) and Exercise 2.12 (ii) p.~66 imply: If $f:X\to Y$ is weakly left exact, then $\fthat:\C_Y^\wedge\to\C_X^\wedge$ commutes with projective limits indexed by small connected categories.
\end{s}
