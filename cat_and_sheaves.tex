% about "categories and sheaves" (version_0027)
...
\subsection{Horizontal and Vertical Compositions (p. 19) 1}\label{hove1}
...
\nn yields the commutative diagram 
...
\nn in $\C_1$. (Here $X$ is in $\C_3$, and it is understood that the $\C_i$ are categories, the $F_{ij}$ are functors, and the $\theta_{ij}$ are morphisms of functors.) We get a well-defined morphism in $\C_1$ from $F_{31}F_{32}X$ to $F_{11}F_{12}X$, which is easily seen to define a morphism of functors from $F_{31}F_{32}$ to $F_{11}F_{12}$. 
...
Using Notation~\ref{nil1} p.~\pageref{nil1} or Notation~\ref{nil2} p.~\pageref{nil2}, Equalities (1.5.8) and (1.5.9) become respectively 
...
The maps $\lambda\mapsto\lambda*\oo j_X$, where $*$ denotes horizontal composition (see Definition~\ref{dil1} p.~\pageref{dil1} or Definition~\ref{dil2} p.~\pageref{dil2}), induce a map $f:L\to R$. Conversely, to an element  
$$
...
\begin{s} 
P.~95, proof of Proposition 4.1.4 (i) (additional details): In Notation~\ref{nil1} p.~\pageref{nil1} or Notation~\ref{nil2} p.~\pageref{nil2}, the sentence of the book ``The two compositions 
$$
\begin{tikzcd}
