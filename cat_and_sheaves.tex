% about "categories and sheaves" (version-0229)
...
\begin{proof}[Proof of Quasi-Terminal Object Theorem (Theorem \ref{qtot})]
...
We claim that $X$ is quasi-terminal. Let $u:X\to Y$ be a morphism. We must show that there is a $v:Y\to X$ such that $v\circ u=\id_X$. 
...
\end{align*}
%
As $b_{i_0}$ is an epimorphism, we conclude that $v\circ u$ is indeed equal to $\id_X$.
\end{proof}
