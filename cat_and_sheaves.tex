% about "categories and sheaves" (version_0127)
...
\end{equation} 
Here and in the sequel, we denote again by $M$ the constant presheaves over $X$ and $U$ attached to the object $M$ of $\A$. We have 
$$
...
$$ 
the two isomorphisms following respectively from the definition of $\cc H\mathit{om}_{\oo{PSh}(X,\A)}$ given in (17.1.14) p.~410 of the book, and from the definition of the functor $\oo j_{U\to X*}$, so that we must show 
$$
