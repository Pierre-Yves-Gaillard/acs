% about "categories and sheaves" (version auk)
...
\right.
$$
the top square being cartesian. Then $\varphi_2$ is a monomorphism by Proposition 17.6.6 p.~425 of the book (recall that $0\to M'\to M\to M''\to0$ is exact by assumption), and $\Delta$ is a commutative diagram of complexes. The condition that the top square is cartesian is equivalent to the exactness of 
%
