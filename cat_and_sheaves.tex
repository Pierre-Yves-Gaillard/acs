...
\begin{s}\lb{8311c} 
The converse to Lemma~\ref{8311} p.~\pr{8311} holds:

Consider the commutative square \qr{837} p.~\pr{837}. If $\Ker f'\xr\sim\Ker f$, then \qr{837} is cartesian. 
...
\end{tikzcd} 
$$ 
and apply Theorem~\ref{5l} p.~\pr{5l} and Theorem~\ref{5ld} p.~\pr{5ld}.
\end{s}
