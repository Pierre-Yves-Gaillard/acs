% about "categories and sheaves" (version_0110)
...
\end{tikzcd}
$$ 
where $G$ is the equivalence of Lemma 1.4.12 p.~26 of the book. The functor $F$ is left exact by Corollary 3.3.19 p.~87 of the book, and the functor $G$ is left exact by Lemma 2.1.13 (ii) p.~41 and Proposition 3.3.3 p. 82 of the book.
\end{s}
