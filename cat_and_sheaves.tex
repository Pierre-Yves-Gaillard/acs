% about "categories and sheaves" (version_0121)
...
Let $X$ be an object of a category $\C$. If $\C$ admits finite projective limits, so does $\C_X$, and $\C_X\to\C$ commutes with such limits.
\end{s}
...
\begin{s}
P. 413, Lemma 17.2.5 (ii). \S\ref{333} p.~\pageref{333} implies: 

If $f:X\to Y$ is a weakly left exact morphism of presites, then its Yoneda extension $\widehat f:\widehat X\to\widehat Y$ is left exact.
\end{s}
