% about "categories and sheaves" (version auf)
...
$$ 
and by putting $Y'_{<0}:=X',w_0:=v_0$. Then $(S_1)$ is clear. Let us prove $(S_i)$ for $i>1$. We may assume that $(S_j)$ holds for all $j<i$. We define $w_i$ and $h_i$ by applying (9.2.5) (ii) (see \eqref{952ii} p.~\pageref{952ii}) to 
$$
Y'_{<i}\xleftarrow{\ p_{i0}}Y'_0\xleftarrow{v_0}X'\xleftarrow{\ f_i}X_i\xr{u_i}Y_i,
$$ 
and we put $u_{ij}:=w_i\circ p_{ij}$, $v_i:=w_i\circ p_{i0}\circ v_0$. From this point, the verification of $(S_i)$ is straightforward. As a result, $(S_i)$ holds for all $i$. 
