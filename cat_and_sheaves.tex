% about "categories and sheaves" (version arv)
...
\noindent(a) $\then$ (b): As $Q(\id_X)=0$, the first part of the exercise implies that $\id_X$ factors as $X\xr fZ\xr g X$. By TR2 there is a d.t. 
$$
...
\noindent(b) $\then$ (c): It suffices to take the direct sum of the d.t. 
$$
\begin{tikzcd} 
