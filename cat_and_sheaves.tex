% about "categories and sheaves" (version_0140)
...
\begin{s} 
P. 427, proof of Proposition 17.6.8. The isomorphism 
$$
\oo j_{A\to X}^\ddagger(\oo j_{A\to X*}(G)(U))\simeq\oo j_{A\to X*}(G)(U\times A\to A)
$$ 
follows from (17.1.12) p.~409 of the book. The fact that $p:A\times U\to U$ is a local isomorphism follows from a the fact that the obvious square 
$$
\begin{tikzcd} 
...
\end{tikzcd}
$$ 
is cartesian and the bottom arrow is a local isomorphism. 
\end{s} 
