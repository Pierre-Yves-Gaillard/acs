% about "categories and sheaves" (version_0041)
...
Let $\alpha:I\to\C$ be a functor, and let $\Gamma(\U)$ be the condition ``$\U$ is a universe, $I$ is $\U$-small, and $\C$ is a $\U$-category''. If $\C$ is a $\U$-category, we write $h_\U$ for the Yoneda embedding from $\C$ to $\C^\wedge_\U$. Let $X$ be an object of $\C$ and $F:\C\to\C'$ a functor. Then we have for all universe $\U$:

\nn{\em(a)} $\Gamma(\U)$ and $\co h_\U\circ\alpha\simeq h_\U(X)$ imply $\co\alpha\simeq X$,

\nn{\em(b)} $\Gamma(\U),\Gamma(\V)$ and $\co h_\U\circ\alpha\simeq h_\U(X)$ imply $\co h_\V\circ\alpha\simeq h_\V(X)$,

\nn{\em(c)} $\Gamma(\U)$ and $\co h_\U\circ\alpha\simeq h_\U(X)$ imply $\co F\circ\alpha\simeq F(X)$. 
\end{prop}
\begin{proof} (a) This is clear. 

\nn(b) We can assume $\U\subset\V$. Put $A:=\co h_\U\circ\alpha$, and define $B\in\C^\wedge_\V$ by setting $B(Y):=A(Y)$ for all $Y$ in $\Ob(\C)$ and $B(f):=A(f)$ for all $f$ in $\Mor(\C)$. This yields $\co h_\V\circ\alpha\simeq B$, and any isomorphism $\pp:h_\U(X)\to A$ induces, by the Yoneda Lemma, an isomorphism $\pp:h_\V(X)\to B$. 

\nn(c) In view of (b) we can assume that $\C'$ is a $\U$-category, and we have, for any $X'$ in $\C'$, 
$$
...
\begin{cor}\label{cuil}
If $\alpha:I\to\C$ is a functor and $X$ an object of $\C$, then the following conditions are equivalent:

\nn{\em(a)} $\co h_\U\circ\alpha\simeq h_\U(X)$ for some universe $\U$ such that $\Gamma(\U)$,

\nn{\em(b)} $\co h_\U\circ\alpha\simeq h_\U(X)$ for all universe $\U$ such that $\Gamma(\U)$, 

\nn{\em(c)} $\co F\circ\alpha\simeq F(X)$ for all functor $F:\C\to\C'$.
\end{cor}

\begin{df}\label{uil}
If the equivalent conditions in Corollary~\ref{cuil} hold, we say that $X$ is a {\em universal} inductive limit \index{universal inductive limit} of $\alpha$.
\end{df}
\end{s}
...
$$ 
If this inductive limit is universal in the sense of Definition~\ref{uil} p.~\pageref{uil}, we say that $F$ is {\em universally} right localizable. \index{universally right localizable}
