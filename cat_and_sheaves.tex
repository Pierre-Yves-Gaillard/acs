...
\begin{s}\lb{1026} 
P.~251, Proposition 10.2.6. Being unable to prove that the localization of $F$ is triangulated in Proposition 10.3.3 p.~253 of the book, %For reasons which will be explained in \S\ref{1033} below, 
I make the extra assumption that $\I$ is \emph{saturated}. %full triangulated subcategory of $\DD$. 
By \S\ref{dtdn}, it is then clear that %I don't know if 
the obvious functor $\I/(\N\cap\I)\to\DD/\N$ is %necessarily 
triangulated, and that any quasi-inverse (if it exists) is also triangulated. 
\end{s}
...
\begin{s}\lb{1033}%\begin{uspb} 
P.~253, Proposition 10.3.3. %\index{unsolved problem} It is claimed that the localization of $F$ is triangulated, but I'm unable to prove this.
%The fact that the localization of $F$ is triangulated follows from Tag~0A8D in the Stacks Project:\smallskip\\ \centerline{\href{http://stacks.math.columbia.edu/tag/0A8D}{http://stacks.math.columbia.edu/tag/0A8D}} 
The fact that the localization of $F$ is triangulated follows from \S\ref{1026} above (see also the diagram on p.~254 of the book). (Recall that I have made the extra assumption that $\I$ is saturated.)
\end{s}%\end{uspb}
