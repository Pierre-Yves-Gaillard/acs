% about "categories and sheaves" (version-0201b)
...
\noindent $*$ P. 438, right after ``q.e.d.'': ``Notations (17.6.13)'' should be ``Notations 17.6.13''. 
...
On the first line of the fourth display, $\overset{\text{\tiny psh}}{\otimes}_{\cc R(V)}$ should be $\otimes_{\cc R(V)}$. 
...
\end{tikzcd}
$$ 
with $\Delta_3:=\Delta_1\oplus\Delta_2$ and $\Delta_5:=\Delta_3\oplus\Delta_4$. Then $\Delta_5$ is distinguished, and, as $X\oplus Y$ is in $\cc N$, Condition N'3 of Lemma 10.2.1 (b) p.~249 implies that $X\oplus TX$ is in $\cc N$.
...
$$ 
where (a) and (c) follow from the fact that the presheaf $f_*\iota_XF$ is actually a sheaf (Proposition 17.5.1 p.~423 of the book), (b) follows from the isomorphism $a_Y\circ \iota_Y\circ a_Y\simeq a_Y$, and the other isomorphisms hold by adjunction. 
\end{s} 
...
$$%\end{equation}%\begin{equation}\label{?2}
$$
\HOM_{\cc R_3}({}_3M_2\otimes_{\cc R_2}{}_2M_1,{}_3M_4)\simeq
\HOM_{\cc R_2}({}_2M_1,\HOM_{\cc R_3}({}_3M_2,{}_3M_4)),
$$%\end{equation}%\begin{equation}\label{?3}
$$
\Hom_{\cc R_3^{\op}}({}_1M_2\otimes_{\cc R_2}{}_2M_3,{}_4M_3)\simeq
\Hom_{\cc R_2^{\op}}({}_1M_2,\HOM_{\cc R_3^{\op}}({}_2M_3,{}_4M_3)),
$$%\end{equation}%\begin{equation}\label{?4}
$$
\HOM_{\cc R_3^{\op}}({}_1M_2\otimes_{\cc R_2}{}_2M_3,{}_4M_3)\simeq
\HOM_{\cc R_2^{\op}}({}_1M_2,\HOM_{\cc R_3^{\op}}({}_2M_3,{}_4M_3)).
$$%\end{equation}
...
\begin{s}
P. 442, proof of Proposition 18.2.7. Here are additional details. Proof of (18.2.12): We must show 
...
\HOM_{k_X}(k_{XA},F), 
$$ 
where (a) follows from \eqref{18212}, (b) follows from Display (18.2.4) p.~439 of the book (which is a particular case of \eqref{HOM}), and (c) follows from \S\ref{homrr}. Let record the isomorphism 
...
\subsection{Proof of Lemma 18.5.3 (p. 447)}%\label{}
