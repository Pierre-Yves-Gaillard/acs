...
\begin{s}\lb{17115ps}
$\frownie$\footnote{The symbol $\frownie$ (``frowny'') means that I'm not satisfied with this \S, and that I'm planning to rewrite it.} P.~410, Display (17.1.15): As already indicated in \S\ref{17115typo}, Display (17.1.15) p.~410 should read 
$$
\Hom_{\PSh(X,\A)}(F,G)\iso\lim_{U\in\C_X}\HOM_{\PSh(X,\A)}(F,G)(U).
$$
...
$\frownie$ (``frowny''). Step~(i), Line~4: I don't know why $K^{\op}$ is cofinally small. 
