...
Soit $C$ un site dont la catégorie sous-jacente est une $\U$-catégorie. Un préfaisceau $F$ à valeurs dans $\U$-Ens est dit séparé (resp. est un faisceau) si pour
tout crible $R$ couvrant $X$, objet de $C$, l'application:
$$
\Hom_{C^\wedge}(X,F)\longrightarrow\Hom_{C^\wedge}(R,F)
$$
