% about "categories and sheaves" (version aua)
...
\nn$\bu$ a family of morphisms $(v_i:X'\to Y'_i)_i$ in $\C_0$ such that $u_{ij}\circ v_j=v_i$ for all $i>j>k$, 

\nn$\bu$ a family of morphisms $(h_i:Y_i\to Y'_i)_i$ in $\C$.
