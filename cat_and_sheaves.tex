% about "categories and sheaves" (version arz)
...
\end{tikzcd}
$$ 
As $\Delta_3=\Delta_1\oplus\Delta_2$ and $\Delta_5=\Delta_3\oplus\Delta_4$, the triangle $\Delta_5$ is distinguished. As $X\oplus Y\in\cc N$, Condition N'3 of Lemma 10.2.1 (b) p.~249 implies $X\oplus TX\in\cc N$.
