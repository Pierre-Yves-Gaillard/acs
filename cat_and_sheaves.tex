% about "categories and sheaves" (version-0245)
...
Going back to the proof of TR5 on p.~275, applying TR5 to 
$$
\begin{tikzcd}
X\ar[equal]{dd}\ar{r}{f}&Y\ar[equal]{d}\ar{r}{\alpha(f)}&TX\oplus Y\ar{r}{\beta(f)}&TX\\
&Y\ar{r}{g}&Z\ar[equal]{d}\ar{r}{\alpha(g\circ f)}&TY\oplus Z\ar{r}{\beta(g)}&TY\\
X\ar[swap]{rr}{g\circ f}&&Z\ar[swap]{rr}{\alpha(g)}&&TX\oplus Z\ar[swap]{rr}{\beta(g\circ f)}&&TX,
\end{tikzcd}
$$ 
we get  
$$
