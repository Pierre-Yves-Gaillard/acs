...
\begin{proof}
Let us denote these six bijections by $f_1,\dots,f_6$; let $u:X\to Y$ be a morphism in $\C$; % in $\Hom_\C(X,Y)$; 
and let us compute successively $f_1u,f_2f_1u,\dots,f_6\dots f_1u$. We have 
$$
