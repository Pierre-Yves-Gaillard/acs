...
\begin{s} 
P. 135, Corollary 6.1.12. As indicated in the book, the proof of Corollary 6.1.12 uses Proposition~\ref{p6112} p.~\pr{p6112}. It also uses implicitly the following lemma:
\begin{lem}
...
\begin{equation}\lb{135}
(\ic\al)(X_1,X_2)\to(\ic\al_1)(X_1)\tm(\ic\al_2)(X_2)
\end{equation}
is bijective.
\end{lem}
\begin{proof}
This follows from Corollary 3.2.3 (ii) p.~79 and Proposition 3.1.11 (ii) of the book. Let us just add that \qr{135} is the natural composition 
$$
