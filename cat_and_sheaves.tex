...
\begin{s}
P. 326. The first isomorphism in the third display follows from the fact that $d_Y^p:Y^p\to Y^{p+1}$ factorizes as $Y^{p-1}\epi\Coker d_Y^{p-1}\to Z^p\mono Y^{p+1}$. (See Proposition 5.1.7 (ii) p.~116 of the book and \S\ref{517ii} p.~\pr{517ii}.)
\end{s}
