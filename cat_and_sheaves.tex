...
%In terms of \S\ref{s232} (a) p.~\pr{s232}, the condition is that there is some $\tau:F\to R_\SSS F\ci Q$ such that the pair $(Q^\dg F,\tau)$ co-represents the functor $$\Hom_{\A^\C}(F,(\ )\ci Q):\A^\C\to\Set.$$ 
\end{s}
