% about "categories and sheaves" (version-0317)
% old version:
...
\begin{lem}\label{817a1} 
Let $X\xr fY\xr gZ$ be morphisms in an abelian category $\C$ (we do not assume $g\circ f=0$). The commutative diagram 
$$
\begin{tikzcd}
...
$$
results from Lemmas \ref{817a1} and \ref{817b1} above and the exactness of $F(X')\to F(K_g)\to0$.
\end{proof} 
