...
\end{lem} 
\begin{proof}
In this proof we write $gf$ for $g\ci f$. Let us verify that the bottom top row is exact at $E$. By Lemma \ref{8312} p.~\ref{8312}, (a)$\ssi$(c), it suffices to check that the solid diagram 
$$
\begin{tikzcd}
