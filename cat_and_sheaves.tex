...
\begin{s}\lb{1057ii} 
[Tag 1]\index{Tag 1}\footnote{I use tags to refer to a part of this text in an other text (private or public). Tags are not renumbered, and appear in the index.}. P.~261, Lemma 10.5.7 (ii). The proof shows that the direct sum in $\SSS^{\wg,add}$ of a small family of objects of $\SSS^{\wg,prod}$ belongs to $\SSS^{\wg,prod}$. 
