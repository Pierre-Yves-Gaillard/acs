% about "categories and sheaves" (version atp)
...
%
\begin{s}
Here are more details about Step~(a) of the proof of Lemma 9.2.5 p.~218: Let $i_1,i_2\in I$ and let $B\subset\Hom_I(i_1,i_2)$ with $\card(B)<\pi$. There exist $j_1\in J$ and a morphism $i_1\to\pp(j_1)$. As $I$ is filtrant, there are morphisms $i_2\to i_3\leftarrow\pp(j_1)$. As $\pp$ is cofinal, there is a morphism $i_3\to\pp(j_2)$. As $J$ is filtrant, there are morphisms $j_1\to j_3\leftarrow j_2$. Let $s\in B$. By Proposition 3.2.2, (i) $\then$ (iii), p.~78 of the book, there is a morphism $j_3\to j(s)$ such that the compositions 
$$
\begin{tikzcd}
i_1
\ar[yshift=0.7ex]{rrrr}{\pp(j_2\to j_3)\circ(i_2\to\pp(j_2))\circ s}
\ar[yshift=-0.7ex]{rrrr}[swap]{\pp(j_1\to j_3)\circ(i_1\to\pp(j_1))}
&&&&\pp(j_3)\ar{rr}{\pp(j_3\to j(s))}&&\pp(j(s))
\end{tikzcd}
$$ 
coincide. Putting $t(s):=(j_1\to j_3\to j(s))$, we get a commutative diagram 
$$
\begin{tikzcd}
...
\nn$\bu$ an inductive system of morphisms $(v_i:X'\to Y'_i)_i$ in $\C_0$, 

\nn$\bu$ a family of morphisms $(h_i:Y_i\to Y'_i)_i$ in $\C$.

\nn Let $i=0$ be the least element of $I$. We define $v_0$ and $h_0$ via Condition (9.5.2) (ii): 
$$
\begin{tikzcd}
...
%
\begin{proof}
By Corollary 3.2.3 p. 79 of the book, the natural functor $\oo j:I^i\to I$ is cofinal. As the obvious morphism of functor 
$$
