% about "categories and sheaves" (version awd)
...
In Step (a) of the proof of Lemma 9.3.1 p.~224 of the book the injectivity of the coprojection $Y_{i_0}(G)\to S$ is used. This injectivity follows from the fact that the coprojection $Y_{i_0}\to Y$ is a monomorphism by the observation made on p.~114 of the book, right after Definition 5.1.1, coupled with Proposition 5.2.3 (ii) p. 118 of the book.
