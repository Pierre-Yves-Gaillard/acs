% about "categories and sheaves" (version awi)
...
In Step (a) of the proof of Lemma 9.3.1 p.~224 of the book the injectivity of the coprojection $Y_{i_0}(G)\to S$ is used. This injectivity can be justified as follows. In the diagram 
$$
\begin{tikzcd}
\co_iY_i\ar{rr}{\sim}&&Y\\ 
{}&Y_{i_0},\ar{ul}{p_{i_0}}\ar{ur}[swap]{q_{i_0}}
\end{tikzcd}
$$ 
let the horizontal arrow be the isomorphism of the first display of the proof of Lemma 9.3.1 p.~224 of the book, let $p_{i_0}$ be the coprojection, and let $q_{i_0}$ be the canonical morphism. Then $q_{i_0}$ is a monomorphism by the observation made on p.~114 of the book, right after Definition 5.1.1. As the diagram commutes, $p_{i_0}$ is also a monomorphism, and Proposition 5.2.3 (ii) p. 118 of the book furnishes the sought-for injectivity. 
