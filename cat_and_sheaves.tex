...
Here are a few comments about the definition of a $\U$-category on page~11 of the book. Let $\U$ be a universe. Recall that an element of $\U$ is called a $\U$-set\index{$\U$-set}. The following definitions are used in the book: 
