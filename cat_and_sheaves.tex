% about "categories and sheaves" (version-0214)
...
$$ 
be such that $x\circ p_j=y_j$ for all $j$, and letting $f_j:\pp(j)\to\xi$ be the obvious morphism, we have $(f_j)\in\lim\Hom_{\C_A}(\pp,\xi)$. q.e.d.
\end{s}
