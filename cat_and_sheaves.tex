% about "categories and sheaves" (version asf)
...
Theorem 13.4.1 and the proof of Theorem 14.4.8 (ii) p.~361 imply that the answer is yes if $\C$ is a Grothendieck category. 
