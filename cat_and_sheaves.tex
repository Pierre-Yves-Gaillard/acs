...
\begin{s}\lb{abar}
P. 160, Proposition 7.3.2. Let $A:\C_\SSS\to\I_\T$ be a quasi-inverse to $\iota_Q$, and let $\bar A:\Ob(\C)\to\Ob(\I)$ be the map induced by $A$. Note that the object $\bar A(X)\in\I$ does \emph{not} depend functorially on $X\in\C$, but $F(\bar A(X))\in\A$ \emph{does}, and is equal to $RF(X)$.
\end{s}
