% about "categories and sheaves" (version awm)
...
$$
\begin{tikzcd}
B\times_AB\ar[yshift=0.7ex]{r}{q_1}\ar[yshift=-0.7ex]{r}[swap]{q_2}&B\ar{d}[swap]{b}\ar{rr}{r}&&A\ar{dl}[swap]{a}\ar{d}{f}\\ 
{}&X_{i_0}\ar{r}[swap]{X_s}&X_i\ar{r}[swap]{p_i}&X_\infty
\end{tikzcd}
$$ 
is, we hope, self-explanatory. Then we have $f\circ r=p_i\circ X_s\circ b=p_i\circ a\circ r$. As $r$ is an epimorphism, this forces $f=p_i\circ a$. 
