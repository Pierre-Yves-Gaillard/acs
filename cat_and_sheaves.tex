% about "categories and sheaves" (version_0060)
...
\begin{s}\label{1811}
P. 436, Example 18.1.1. It seems to me the authors forget to define the {\em constant sheaf} \index{constant sheaf} $R_X$ \index{$R_X,k_X,M_X$}. I think it is the sheaf associated to the appropriate constant presheaf.
