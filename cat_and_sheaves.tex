...
\begin{proof}
Let $s:V\to U$ be a morphism in $\C$ and $S$ a sieve over $U$. It suffices to show that $s$ is in $S$ if and only if $s$ factors through the natural morphism $i:A_S\to U$.
