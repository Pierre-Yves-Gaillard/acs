...
\begin{s}
Proof of Lemma 10.5.7 (ii) p. 262. We adhere to the notation of the lemma. %Consider the commutative diagram 
...
\begin{s}\lb{brown}
P.~264, proof of Lemma 10.5.11. It is not hard to prove (using \S\ref{ccaf} p.~\pr{ccaf} and \S\ref{1057ii} p.~\pr{1057ii} in particular) that small filtrant inductive limits are exact on $\SSS^{\wg,prod}$. %the functor $\left(\SSS^{\wg,prod}\right)^{\bb N}\to\SSS^{\wg,prod}$ mapping $\al$ to $\col\al$ is exact. (Here $\bb N$ stands abusively for the category attached to the set $\bb N$ equipped with its natural order.)
\end{s}
...
\begin{s}
P. 280, Example 11.3.5 (i). It is written ``Let $f:X\to Y$ be a morphism in $\C$. We identify $f$ with a morphism in $\text C(\C)$. Then $\Mc(f)$ is the complex 
$$
