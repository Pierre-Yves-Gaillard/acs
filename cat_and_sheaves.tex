% about "categories and sheaves" (version awo)
...
\begin{cor}
Assume (9.3.1). Then for any small subset of $\Ob(\C)$ there exists an infinite cardinal $\pi$ such that $S\subset\Ob(\C_\pi)$.
\end{cor}
