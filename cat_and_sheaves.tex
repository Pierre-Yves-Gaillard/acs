% about "categories and sheaves" (version avh)
...
Task $(T_i)$ has been achieved for the specific $i$ we have been considering, and thus Task $(T_i)$ has been achieved for all $i$ in $I$. In particular Task $(T_m)$, where, remember, $m$ is the maximum of $I$, has also been achieved. Putting
$$
