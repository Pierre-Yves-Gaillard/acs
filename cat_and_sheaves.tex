...
\begin{prop}\lb{p711}
If $\C$ is a category and $\SSS$ is a set of morphisms in $\C$, then the localization $\C_\SSS$ of $\C$ at $\SSS$ exists and is unique us to unique isomorphism.
...
\end{prop}
\begin{lem}\lb{l711}
If $\C$ is a category and $\SSS$ is a set of morphisms in $\C$, then there is a category $\C'$ and a functor $Q:\C\to\C'$ such that any functor $\C\to\A$ turning the morphisms of $\SSS$ into isomorphisms factors uniquely through $Q$. Moreover this category is unique up to unique isomorphism.
...
\end{proof}
\begin{proof}[Proof of Proposition \ref{p711} (sketch)] 
We claim that the functor $Q:\C\to\C'$ in Lemma \ref{l711} defines a localization $\C_\SSS$ of $\C$ at $\SSS$ in the sense of Definition 7.1.1. %(The key point is to verify Condition~(c) of Definition 7.1.1 p.~149; see \S\ref{7116} p.~\pr{7116} below.) 
We sketch the proof that $Q$ satisfies Condition~(c) of Definition 7.1.1 p.~149 of the book and leave the rest of the proof to the reader. Let $F,G$ be in $\A^{\C'}$ and consider the map 
$$
\star Q:\Hom_{\A^{\C'}}(F,G)\to\Hom_{\A^\C}(F\ci Q,G\ci Q),
$$ 
where $\star$ denotes the horizontal composition (see Definition~\ref{dil1} p.~\pr{dil1}). We shall define a putative inverse 
$$
\Phi:\Hom_{\A^\C}(F\ci Q,G\ci Q)\to\Hom_{\A^{\C'}}(F,G)
$$ 
to $\star Q$. For $\ld$ in $\A^\C(F\ci Q,G\ci Q)$ and $X$ in $\C$ we define set $\Phi(\ld)_X:=\ld_X:F(X)\to G(X)$. We must show that the square 
$$
\begin{tikzcd}
...
\begin{s}
P. 155, Theorem 7.1.16. If we define $\C_\SSS$ by Lemma~\ref{l711} p.~\pr{l711}, it is easy to check that, for $X$ and $Y$ in $\C$, the natural map 
$$
...
See Proposition~\ref{rsf}. By Lemma~\ref{l711} p.~\pr{l711} there is a unique functor $F_\T:I_\T\to\A$ such that % condition (b) in Definition 7.1.1 we have
