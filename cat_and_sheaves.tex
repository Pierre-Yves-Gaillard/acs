% about "categories and sheaves" (version axc)
...
\end{tikzcd}
$$ 
can be completed as indicated (the morphism $B\to A$ being an epimorphism).
...
\end{tikzcd}
$$ 
can be completed as indicated, with $\card(C(G))<\pi$ (the morphism $C\to A$ being an epimorphism).
