...
\begin{muspb}
About\index{Major Unsolved Problem} Definition 17.3.1(ii): Let $X$ be a site, let $\U\subset\V$ be universes, let $F\in\PSh(X,\U\textbf{-set})$ be a $\U\textbf{-set}$-valued presheaf and let $F'\in\PSh(X,\V\textbf{-set})$ be the corresponding $\V\textbf{-set}$-valued presheaf. Is the implication ``$F$ sheaf $\implies F'$ sheaf'' true?
\end{muspb}
