% about "categories and sheaves" (version_0149)
...
%\begin{s} P. 431, Exercise 17.5 (ii). The statement follows from the fact, in the notation of the exercise, we have, for $U$ in $\C_X$ and $(U\to A)\in\C_A$, an isomorphism $$\cc{LI}_{U\to A}\simeq\cc{LI}_U.$$\end{s} 
