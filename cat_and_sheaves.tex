...
$$
\iota_\A(RF(Q(X)))\iso R(\iota_\A\ci F)(Q(X))\iso IF(\al_\SSS(Q(X)))
$$
$$
\iso IF\left(\col_{(X\to X')\in\SSS^X}\iota_\C(X')\right)\iso\col_{(X\to X')\in\SSS^X}\iota_\A(F(X')), 
$$
the isomorphisms following respectively from the assumption that $F$ is universally right localizable, (7.4.3) p.~162 of the book, Proposition 7.4.1 p.~162 of the book and Proposition 6.1.9 p.~133 of the book.
\end{s}
