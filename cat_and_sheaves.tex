% about "categories and sheaves" (version-0352)
% old version:
...
\Delta:=\left\{
\begin{tikzcd}
N\ar{r}\ar{d}[swap]{k_2}&(\cc R^{\op}|_U)^m\ar{d}{f_2}\\ 
...
\end{tikzcd}
$$ 
(commutative diagram which completes \eqref{pumb}) has also a cartesian top square. We have used the isomorphisms 
%
...
$$ 
If $t$ is the element of $(N\otimes_{\cc R|_U}P|_U)(U)$ corresponding to $x$ under Isomorphism~\eqref{nrpu}, then we get $k_1(t)=(b_i)$, and thus $\overline s=g_1((b_i))=g_1(k_1(t))=0$. By \eqref{s=0il}, this completes the proof.   
\end{proof}
