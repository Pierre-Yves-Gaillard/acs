% about "categories and sheaves" (version-0380)
% old version:
...
\nn$\si$: Let $\Delta:\C\to\C^\C$ be the diagonal functor, let $p\in\Hom_{\C^\C}(\id_\C,\Delta(T))$ be a $\Hom_{\C^\C}(\id_\C,\Delta(\ ))$\--co-universal element  (see Definition~\ref{ue2} p.~\pageref{ue2}), and let $X$ be an object of $\C$. It suffices to show 
%
