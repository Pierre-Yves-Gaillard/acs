% about "categories and sheaves" (version-0223)
...
$$ 
Proposition \ref{932} p.~\pageref{932} implies $G$ is in $\C_{\pi_0}$. Now choose a cardinal $\pi_1\ge\pi_0$ such that we have for all set $A$ with $\card(A)<\pi_0$: 
