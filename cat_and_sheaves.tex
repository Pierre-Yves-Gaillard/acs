% about "categories and sheaves" (version-0182)
...
$$
\psi(F)\simeq\colim_{(Y\to F)\in\F_F}Y. 
$$ 
\end{lem} 
...
$$
\Hom_\C\left(\colim_{(Y\to F)\in\F_F}Y,X\right)\simeq\lim_{(Y\to F)\in\F_F}\Hom_\C(Y,X)
$$ 
$$
\simeq\lim_{(Y\to F)\in\F_F}\varphi(X)(Y)\simeq\Hom_{\F^\wedge}(F,\varphi(X)),
$$  
