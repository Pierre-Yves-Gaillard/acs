...
\begin{s}%\lb{1033} 
P.~253, Proposition 10.3.3. The fact that the localization of $F$ is triangulated follows from Exercise 8.4 p.~202 (see Section~\ref{84} p.~\pr{84}) and \S\ref{1026} above (see also the diagram on p.~254 of the book). (Recall that I have made the extra assumption that $\I$ is saturated.)
\end{s}
...
\begin{s}
P. 330, proof Corollary 13.3.3. In view of \S\ref{330} above, it is not clear to me that the argument given in the book is complete.
\end{s}
