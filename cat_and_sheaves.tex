...
\end{equation} 
where the last isomorphism follows from the hypothesis that $\col_iX_i\to Y$ is an epimorphism together with Proposition 5.1.2 (iv). It is easy to see that the chain of isomorphisms \qr{col_iY_i} coincides with the natural morphism $\col_iY_i\to Y$, and that the coprojections $Y_i\to Y$ are monomorphisms. In particular the $Y_i(G)\to Y(G)$ are monomorphisms too by Proposition~\ref{333} p.~\pr{333} and Proposition~\ref{34i} p.~\pr{34i}. 
\begin{uspb}
The book claims that $\col_iY_i(G)\to Y(G)$ is also a monomorphism, but I'm unable to prove it.\index{unsolved problem}
\end{uspb}
