% about "categories and sheaves" (version-0340)
% old version:
...
$$ 
If $t$ is the element of $(N\otimes_{\cc R|_U}P|_U)(U)$ corresponding to $x$, then we get $k_1(t)=(b_i)$, and thus $s=f_1((b_i))=f_1(r_1(t))=0$. By \eqref{s=0il}, this completes the proof.  
\end{proof}
