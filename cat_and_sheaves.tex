% about "categories and sheaves" (version-0374)
% old version:
...
The maps $\ell\mapsto\ell*\oo j^X$, where $*$ denotes horizontal composition (see Definition~\ref{dil1} p.~\pageref{dil1}), induce a map $f:L\to R$. Concretely, to a family 
$$
