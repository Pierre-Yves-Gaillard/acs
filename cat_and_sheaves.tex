% about "categories and sheaves" (version 0022)
...
\subsection{Horizontal and Vertical Compositions (p.~19)} \label{hove} %\index{horizontal composition} \index{vertical composition}
%
...
We shall define vertical composition \index{vertical composition} of morphisms of functors, denoted by $\circ$, and horizontal composition \index{horizontal composition} of morphisms of functors, denoted by $*$\index{$*$}, and prove 
%
...
Denoting vertical composition by $\circ$ and horizontal composition by $*$ (see Section~\ref{hove} p.~\pageref{hove}), Equalities (1.5.8) and (1.5.9) become respectively 
%
...
The maps $\lambda\mapsto\lambda*\oo j_X$, where $*$ denotes horizontal composition (see Section~\ref{hove} p.~\pageref{hove}), induce a map $f:L\to R$. Conversely, to an element  
$$
...
\begin{df}
Let $\C$ be a category. A {\em projector} \index{projector} on $\C$ is the data of a functor $P:\C\to\C$ and a morphism $\ee:\id_\C\to P$ such that the horizontal compositions (see Section~\ref{hove} p.~\pageref{hove}) $\ee*P$ and $P*\ee$ are isomorphisms. 
\end{df}
...
%
\begin{s} 
P.~95, proof of Proposition 4.1.4 (i) (additional details): Let us denote vertical composition by $\circ$ and horizontal composition by $*$ (see Section~\ref{hove} p.~\pageref{hove}). In view of \eqref{intlaw} p.~\pageref{intlaw}, Equality 
%
