...
\begin{prop}\lb{p3cat}Let $\U$ be a universe, let $\Set$ be the category of $\U$-sets, let $Z$ be in $\Set$, and let $Z'$ be the discrete category whose set of object is $Z$. Then there are canonical isomorphisms$$\Set_Z\iso\prod_{z\in Z}\Set\iso\Fct(Z',\Set).$$\end{prop}
...
(v) follows %(with the change suggested in \S\ref{14112} p.~\pr{14112}) 
from Corollary 14.1.12 (iii) p.~352 of the book, 
