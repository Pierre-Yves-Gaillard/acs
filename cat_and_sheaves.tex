% about "categories and sheaves" (version_0030)
...
It seems more prudent to assume that $\C$ is a $\U$-small category, and that $\A$ and $\A'$ are big categories (see Remark~\ref{url} p.~\pageref{url}).
...
\begin{s}\label{durl}
P. 159, Definition of universally right localizable functor (Definition 7.3.1 (ii)). Here is how I understand the definition (see Remark~\ref{url} p.~\pageref{url}): $\C$ is a $\U$-small category, $\A$ and $\A'$ are big categories.
\end{s}
...
\begin{s}\label{ltf}
P. 253, Definition of right localizable functor with respect to $(\cc N,\cc N')$ (Definition 10.3.1). I think it is simpler to define the notion of universally right localizable functor as in \S\ref{durl} p.~\pageref{durl} (see Remark~\ref{url} p.~\pageref{url}).
\end{s}
