...
\sbs{Definition of a commutative group object (p. 169)}

The following definition is much less general and much less elegant than the one in the book, but it is slightly simpler and seems sufficient in this context. 
...
\begin{s}\lb{gcsbc}
P.~186, Definition 8.3.24 (definition of a Grothendieck category\index{Grothendieck category}). By Lemma 3.3.9 p.~83 of the book, in a Grothendieck category $\U$-small filtrant inductive limits are stable by base change (Definition 2.2.6 p.~47 of the book, stated above as Definition~\ref{dsbc} p.~\pr{dsbc}).
\end{s}
...
\subsubsection{Corollary 8.3.26 (p.~189)}
