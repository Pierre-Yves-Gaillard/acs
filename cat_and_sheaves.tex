% about "categories and sheaves" (version-0242)
...
\end{tikzcd}
$$
where the second row is obtained from $X^2\xr aW\xr bZ^1\xr cTX^2$ in \eqref{v1} by TR3 and TR0, and the last row is obtained by TR2, we get by TR5 
%
