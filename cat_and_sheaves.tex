% about "categories and sheaves" (version_0155)
...
%\noindent(See (\ref{convnot}) p.~\pageref{convnot} for an explanation of the notation.) 
...
$$
%(See (\ref{convnot}) p.~\pageref{convnot} for an explanation of the notation.) 
