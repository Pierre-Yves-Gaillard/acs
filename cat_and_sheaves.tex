% about "categories and sheaves" (version_0045)
...
If the above equivalent conditions hold, we say that $\pp^\dagger\beta$ {\em exists}. If $\pp^\dagger(F\circ\beta)$ exists for all functor $F:\C\to\C'$, we say that $\pp^\dagger\beta$ exists {\em universally}.
\end{df}
\end{s}
...
\co_{(\pp(j)\to i))\in J_i}\beta(j)
\end{equation}
%
exists in $\C$ for all $i$ in $I$, then $\pp^\dagger\beta$ exists and is isomorphic to \eqref{e233}. If, in addition, \eqref{e233} exists universally in the sense of Definition~\ref{uil} p.~\pageref{uil}, then $\pp^\dagger\beta$ exists universally in the sense of Definition~\ref{232}. 
\end{thm}
\end{s}
...
\begin{df}\label{uil}
If the natural map $\co\Hom_\C(Y,\alpha)\to\Hom_\C(Y,X)$ is bijective for all $Y$ in $\C$, we say that $X$ is a {\em universal} inductive limit \index{universal inductive limit} of $\alpha$, and that $\co\alpha$ exists {\em universally} \index{universal existence of a limit} in $\C$.
\end{df}
...
\nn{\em(b)} $\co h_\U\circ\alpha\simeq h_\U(X)$ for some universe $\U$ such that $I$ is $\U$-small and $\C$ is a $\U$-category,

\nn{\em(c)} $\co h_\U\circ\alpha\simeq h_\U(X)$ for all universe $\U$ such that $I$ is $\U$-small and $\C$ is a $\U$-category, 

\nn{\em(d)} $\co F\circ\alpha\simeq F(X)$ for all functor $F:\C\to\C'$. 
\end{prop}
