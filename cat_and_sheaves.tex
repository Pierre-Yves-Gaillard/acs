% about "categories and sheaves" (version_0037)
...
\begin{s}\label{ltf}
P. 253, Definition of right localizable functor with respect to $(\cc N,\cc N')$ (Definition 10.3.1). I think it is simpler to define the notion of universally right localizable functor as in \S\ref{durl2} p.~\pageref{durl2} (see Remark~\ref{rurl} p.~\pageref{rurl}).
\end{s}
