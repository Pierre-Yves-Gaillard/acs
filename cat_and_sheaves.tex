% about "categories and sheaves" (version-0188)
...
\Hom_{\C^\wedge}(\ \ ,B)
$$ 
in $\Ind(\C)^\wedge_\V$, where $\V$ is a universe containing $\U$ such that $\C^\wedge$ is a $\V$-category. %Using the notation in \eqref{convnot} p.~\pageref{convnot}, 
We have 
$$
\widetilde F(A):=\colim_{(X\to A)\in\C_A}F(X),
$$ 
