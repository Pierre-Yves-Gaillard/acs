...
\end{equation}
(See Lemma 1.4.12 p.~26 of the book.) 
...
\nn by \eqref{leq}, \eqref{lcom} and Proposition~2.7.1 (see p.~62 of the book). We also have 

$$h(\C)^\ddagger(j((\C^\wedge)_A))(U\to A)\simeq F(U)$$

\nn by Proposition~2.7.1. For $B$ in $\C^\wedge$ and $B\to A$ in $(\C^\wedge)_A$, we have 
...
\nn where (a) follows from \eqref{263a} p.~\pageref{263a}; (b) follows from Lemma 2.1.13 (i) p.~41 of the book; (c) follows from \eqref{leq}, \eqref{lcom} and Proposition~2.7.1 (see p.~62 of the book); and (d) follows from Proposition~2.7.1. A similar computation shows 
$$
...
(b) follows from \eqref{lcom} and Proposition~2.7.1 (see p.~62 of the book);  
(c) follows from Lemma 2.1.13 (i) p.~41 of the book; 
...
(e) follows from Proposition~2.7.1.
\end{proof}
