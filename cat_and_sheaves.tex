% about "categories and sheaves" (version-0196)
...
The authors say that the equivalence (iv) $\ssi$ (iii) is obvious. I agree, but here are a few more details. Implication (iv) $\then$ (iii) is indeed obvious in the strongest sense of the word. Implication (iii) $\then$ (iv) can be proved as follows. 
