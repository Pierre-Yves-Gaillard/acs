...
% about "categories and sheaves" (version-0237)
...
$$ 
As $\theta$ is a monomorphism, Proposition 3.3.3 p.~82 of the book and Proposition~\ref{34i} p.~\pageref{34i} above imply that $\colim\theta$ is also a monomorphism. Then the conclusion follows from the commutativity of the diagram 
$$
\begin{tikzcd}
