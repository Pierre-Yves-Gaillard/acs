% about "categories and sheaves" (version awj)
...
In Step (a) of the proof of Lemma 9.3.1 the injectivity of the coprojection $Y_{i_0}(G)\to S$ is used. This injectivity can be justified as follows. In the diagram 
$$
\begin{tikzcd}
\co_iY_i\ar{rr}{\sim}&&Y\\ 
