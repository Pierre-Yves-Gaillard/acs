% about "categories and sheaves" (version asw)
...
$$ 
the penultimate isomorphism following from the fact that small inductive limits in the category of sets exist and are stable by base change (see \S\ref{bc} p.~\pageref{bc}).
\end{s}
%
%%
%
...
\end{equation}
% 
The sequence $\Sigma\otimes_{\cc R|_U}P|_U$ being exact thanks to the assumption in Lemma~\ref{l1853}, we see that the commutative diagram of complexes $\Delta\otimes_{\cc R|_U}P|_U$ has a cartesian top square, and that, by left exactness of $\Gamma(U,-)$, the commutative diagram of complexes $\Gamma(U,\Delta\otimes_{\cc R|_U}P|_U)$, that is, 
$$
\begin{tikzcd}
