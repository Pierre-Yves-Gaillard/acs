% about "categories and sheaves" (version-0291)
...
\end{equation}
%
As we have $\ee_{P(X)}\circ u=P(\ee_X)$ by definition of $u$, and $P(\ee_X)\circ\ee_X=\ee_{P(X)}\circ\ee_X$ by naturality of $\ee$, we get 
$$
