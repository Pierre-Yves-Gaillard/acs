% about "categories and sheaves" (version-0170)
...
\eqref{prepa4c} follows from the fact that small inductive limits in $\Set$ are stable by base change.
...
\begin{s} 
P.~63, Notation 2.7.2. Recall that $F:\C\to\C'$ is a functor of small categories. The formula 
$$
...
Let us assume that $A$ is a terminal object of $\C^\wedge$. We have 
$$
...
$$ 
be the coprojection, define the functor 
$$
...
$$ 
Then the composition of $G$ with the forgetful functor $\C'_{\widehat F(A)}\to\C'$ is $F$.
\end{s}
