% about "categories and sheaves" (version axb)
...
The exactness of $\co_{s\in I^{i_0}}$ in $\C$, invoked in the penultimate line of p.~224, and the isomorphism 
$$
...
$$ 
the first equality following from the penultimate display of p.~225 of the book, the second equality being obvious, and the third equality following from the definition of $a$. As $r$ is an epimorphism, this forces $f=p_i\circ a$. 
