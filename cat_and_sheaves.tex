...
\begin{muspb}\lb{334}
P. 334,\index{major unsolved problem}\index{unsolved problem} proof that $\J$ is cogenerating in the proof of Lemma 13.3.12. I don't understand the argument. (See also Major Unsolved Problem~\ref{361} p.~\pr{361} below. The notion of cogenerating full subcategory is defined on p.~184 of the book, and the notion of $F$-injective full subcategory is defined on pages 253 and 330 of the book.)
\end{muspb}
