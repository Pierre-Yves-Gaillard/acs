...
\begin{rk}\lb{954}
In the book $\F$ is supposed to be small, but the proof clearly works if $\F$ is only essentially small. %the set of isomorphisms classes of elements of $\F$ has a small cardinal.
(See Remark~\ref{deF} p.~\pr{deF} above and \S\ref{962} below.)
\end{rk}
...
%\begin{muspb}
%The\index{major unsolved problem}\index{unsolved problem} proof of Lemma 10.5.11 p.~264 invokes Exercise 8.37 p.~211. I failed to solve Exercise 8.37, and I don't understand the proof of Lemma 10.5.11, even taking Exercise 8.37 for granted.
%\end{muspb}
...
\end{tikzcd}
$$ 
\emph{be a commutative diagram in $\C$. If $ZXUW$ %the big square (or ``rectangle'') 
is cocartesian, then so is $YXUV$.}%the right small square is cocartesian too.}
%\emph{be a commutative diagram in $\C$. If the left small square and the big square (or ``rectangle'') is are cocartesian, then the right small square is cocartesian too.}
\end{s}
...
%\begin{muspb}\lb{334}P. 334,\index{major unsolved problem}\index{unsolved problem} proof that $\J_F$ is cogenerating in the proof of Lemma 13.3.12. I don't understand the argument. (See also Major Unsolved Problem~\ref{361} p.~\pr{361} below. The notion of cogenerating full subcategory is defined on p.~184 of the book, and the notion of $F$-injective full subcategory is defined on pages 253 and 330 of the book.)\end{muspb}
...
\end{tikzcd}
$$ 
where the top row is an exact complex, where $g'$ is induced by $g$ and where the square $(\Ker f,W^0,Y,Z)$ is cocartesian. Then Lemma~\ref{cart1} p.~\pr{cart1} %Lemma~\ref{738a} p.~\pr{738a} 
...
$$
\widetilde h:T^{-1}Z\to I,\quad\widetilde\psi:Y\to I,\quad\psi:Y\to I,\quad h:T^{-1}Y\to I,\quad\xi:Z\to I
$$ 
...
\begin{s} 
P.~358. Lemma 14.4.1 will be used to prove Theorem 14.4.3 p.~359 and Theorem 14.4.5 p.~359 of the book.
\end{s}

%

\begin{s}
P. 358, proof of Lemma 14.4.1. We have the following chain of isomorphisms in $\oo D(\C)$:
$$
...
Here is a rewriting of the last three lines:
...
%\begin{muspb}\lb{361}P. 361,\index{major unsolved problem}\index{unsolved problem} proof of Corollary 14.4.6. I don't see why the epimorphism $P_i\epi\al(i)$ used in the proof of Corollary 14.4.6 exists. (See also Major Unsolved Problem~\ref{334} p.~\pr{334} above. The notion of generating full subcategory is defined on p.~184 of the book, and the notion of $F$-projective full subcategory is defined on pages 253 and 330 of the book.)\end{muspb}
...
\end{tikzcd}
$$ 
%\begin{muspb}The\index{major unsolved problem}\index{unsolved problem} book claims that $F\to G$ is an isomorphism, but I haven't been able to verify this.\end{muspb}
