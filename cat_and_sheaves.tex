...
Let us denote the object $X$ above by $X_1\oplus X_2$. %For the reader's convenience we state and prove Lemma 8.2.3 (ii) p.~169 of the book:
...
Let $\C$ be a pre-additive category, $X,Y\in\C$ and $f_1,f_2\in\Hom_\C(X,Y)$. Assume that the direct sums $X\oplus X$ and $Y\oplus Y$ exist. Then $f_1+f_2\in\Hom_\C(X,Y)$ coincides with the composition 
$$
