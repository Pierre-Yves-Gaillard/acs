% about "categories and sheaves" (version-0179)
...
Proof of (v): We add a few details. Recall the setting: the category $\C$ admits finite projective limits, small coproducts, and a generator $G$. We already know that $G$ is conservative, left exact, and preserves monomorphisms. 
