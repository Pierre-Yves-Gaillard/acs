% about "categories and sheaves" (version asi)
...
%
\begin{s} 
P.~395, Lemma 16.2.3 (iii). [Warning: I convinced myself that there following statement was correct, but I don't remember why... I might have made a mistake. I'm working on that.] Consider the conditions
...
Recall that (a) is the condition that $A\to B$ is a local monomorphism. Parts (ii) and (iii) of Lemma 16.2.3 imply 
%
