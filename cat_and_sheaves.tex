% about "categories and sheaves" (version-0371)
% old version:
...
$$
r=(r_X)_X=\Big(\big(r_{X,y:Y\to X}:F(Y)\to G(Y)\big)_{y:Y\to X}\Big)_X\in R
$$ 
...
$$
\Big(\big(r_{X,y:Y\to X}:F(Y)\to G(Y)\big)_{y:Y\to X}\Big)_X
$$ 
...
in $\C$, we have 
$$
r_{Y,z}\circ F(z)=G(z)\circ r_{X,f}.
$$
\end{s}
