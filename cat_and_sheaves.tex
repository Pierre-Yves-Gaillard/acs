% about "categories and sheaves" (version_0078)
...
Let $(\Gamma_U)_{U\in\C}$ be a subfamily of the family $(\Sigma_U)_{U\in\C}$ satisfying GT1-GT4, and let $\cc E=\cc E(\Gamma)$ be the set of those morphisms $A\to B$ in $\C^\wedge$ such that, for any morphism $U\to B$ in $\C^\wedge$ with $U$ in $\C$, the sieve $S_{A\times_BU}$ is in $\Gamma_U$. 
...
$$
Let us check that $(\Gamma_U)_{U\in\C}=:\Gamma(\cc E)$ satisfies GT1-GT4.
