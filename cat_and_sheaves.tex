...
$$\simeq\lim_{(B\to U)\in\C^B}F(U)\simeq h(\C)^\ddagger(F)(B)
...
%\begin{s}\label{prepa5}P.~409, Proposition 17.1.9 follows immediately from \eqref{prepa1} p.~\pageref{prepa1}, \eqref{prepa2} p.~\pageref{prepa2}, and \eqref{prepa3} p.~\pageref{prepa3}.\end{s}
