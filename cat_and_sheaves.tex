% about "categories and sheaves" (version ave)
...
Now assume that $i>0$ and that the $Y'_{<j},Y'_j,h_j,v_j,w_j$ have already been constructed for $j<i$, that the $p_{jk}$ have already been constructed for $k<j<i$, and that all these morphisms satisfy the required conditions. For $k<j<i$ we define $
...
\end{tikzcd}
$$
From this point, it is straightforward to prove that the task has indeed been achieved. 
