% about "categories and sheaves" (version_0088)
...
Claim: Let $s:V\to U$ be a morphism in $\C$. Then $s\in S$ if and only if $s$ factors through the natural morphism $A_S\to U$.
