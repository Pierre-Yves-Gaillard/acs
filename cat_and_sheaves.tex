% about "categories and sheaves" (version-0257)
...
Proof of the claim: Let $V\to B$ be a morphism in $\C_Y^\wedge$ with $V$ in $\C_Y$. Then $u_V: A\times_BV\to V$ is either a monomorphism or an epimorphism (see Section~\ref{coll} p.~\pageref{coll}). Let us show that $\fthat(u_V)$ is a local isomorphism. 
