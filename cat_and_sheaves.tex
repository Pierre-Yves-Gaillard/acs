...
Let $(J(U))_{U\in\C}$ be a subfamily of the family $(\Sigma_U)_{U\in\C}$ satisfying GT1\--GT4, let $\U$ be a universe such that $\C$ is $\U$-small (Definition~\ref{myuscat} p.~\pr{myuscat}), and let 
...
\begin{thm}
If $\C$ is a $\U$-small category (Definition~\ref{myuscat} p.~\pr{myuscat}), if $\Gamma$ is a subfamily of $(\Sigma_U)_{U\in\C}$ satisfying GT1-GT4, and if $\E$ is a set of morphisms in $\C^\wg_\U$ satisfying LE1-LE4, then the equalities $\E=\E(\Gamma,\U)$ and $\Gamma=\Gamma(\E)$ are equivalent.
\end{thm}
...
By Part~\ref{v311} of Lemma~\ref{v31} there is a commutative diagram 
$$
\begin{tikzcd}
&F\ar[r,hookrightarrow,"\ell(F)"]&LF\\ 
