% about "categories and sheaves" (version aig)
...
\begin{rk}\label{732}
Under the assumptions of \pr\ 7.3.2, the right localization $(\C_{\cc S},Q)$ of $\C$ is universal in the sense of Definition~\ref{url}.
\end{rk}
