% about "categories and sheaves" (version aje)
...
\bc\label{1334}
P. 330, Definition 13.3.3. It would be better (I think) to replace $\text K^+$ and $\text N^+$ with $\text K^*$ and $\text N^*$, where $*$ is a boundedness condition (that is, one the three symbols $-,+,\text b$, or the empty symbol) determined by the context. [In Chapter~14, ``$\cc P$ is $F$-projective'' always means --- if I understand correctly --- ``$K(\cc P)$ is $K(F)$-projective''.]
\ec
...
\n P. 361, Corollary 14.4.6 (ii). It is better (I think) to add the assumption that $\cc P$ is generating.
