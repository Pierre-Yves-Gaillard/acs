% about "categories and sheaves" (version ahp)
...
\n$\bu$ P. 424, proof of Theorem 17.5.2 (iv). Firstly, as already mentioned, there is a typo: ``The functor $f^\dagger$ is left exact'' should be ``The functor $f^\dagger$ is exact''. Secondly, to be slightly more explicit, one could replace ``The functor $f^\dagger$ is exact by Theorem 3.3.18'' with ``The functor $f^\dagger$ is exact by Theorem 3.3.18 and Display~\eqref{407} p.~\pageref{407}''.
