% about "categories and sheaves" (version ahm)
...
\n$\bu$ P. 406. The isomorphism 
$$
\big((f^t)\,\hat{}\,(A)\big)(U)\simeq\co_{(U\to f^t(V))\in(\C_Y)^U}A(V)
$$
follows from \eqref{275} p.~\pageref{275}.
...
%\n$\bu$ P. 421. I don't understand the proof of Lemma 17.4.6 (i) p. 421. 
%(9:37 AM, Sunday, August 18, 2013 (CEST). Unsolved.)
