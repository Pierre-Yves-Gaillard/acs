% about "categories and sheaves" (version aio)
...
\n$\bu$ P.~159, Definition 7.3.1 (ii). The following conditions on the right localization $(\C_{\cc S},Q)$ of $\C$ are equivalent: 
...
\end{rk}
%
%Note that \pr\ 7.3.2 is used in a crucial way in the sequel of the book.
...
$$ 
for $X\in\cc S$. Also note that Convention~\ref{payc} p.~\pageref{payc} can be applied.\bigskip 

%%

\begin{cm}\label{pg270}\footnote{See footnote to Comment \ref{t955} p. \pageref{t955}} 
%
...
\n$\bu$ P. 337. I would state Theorem 13.4.1 as follows:
...
\n$(13.4.1)\hskip6em H^0\oo R\Hom_\C(X,Y)\simeq\Hom_{D(\C)}(X,Y).$\bigskip
...
\n$\bu$ P.~349, proof of \pr\ 14.1.6, Step~(ii). Here are some more details about the verification that $\widetilde\psi:Y\to I$ is a morphism in $\A_c$. 
...
\bc\footnote{See footnote to Comment \ref{t955} p. \pageref{t955}} 
P. 350, proof of Theorem 14.1.7. See Comment \ref{t955} p. \pageref{t955}.
\ec
...
\n$\bu$ P.~352, Corollary 14.1.12 (iv). Here are slightly more precise statements. 
