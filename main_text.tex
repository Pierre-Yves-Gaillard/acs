...
\n$\bu$ P. 147, Exercise 6.11. Recall the setting: $\cc J$ is a full subcategory of a category $\cc C$, and $A$ is in $\Ind(\cc C)$. Let $F:\cc J\to\cc C$ be the inclusion, let $A$ be in $\Ind(\cc I)$, and consider the conditions 
