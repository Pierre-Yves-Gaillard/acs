% about "categories and sheaves" (version ajy)
...
\n P.~250, line 1: ``TR3'' should be ``TR2''. After the second diagram, the $s\circ f$ should be an $f\circ s$.
...
It is easy to prove the lemma using the Freyd-Mitchell Theorem (p.~238 of the book). Although it is not fully satisfactory, we shall be content with that argument. (In the sequel of this comment, we shall leave to the reader several statements to which the same remark applies.)
