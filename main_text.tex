% about "categories and sheaves" (version amq)
...
\begin{comment}
\begin{s}
Theorem 14.4.8 p.~361. Here is a remark that could be inserted between the statement and the proof of Theorem 14.4.8. We write $G$ and $F_i$ for $\oo K(G)$ and $\oo K(F_i)$.
\begin{rk}\label{1448}
Let $X_i$ be in $\oo K(\C_i)$ for $i=1,2,3$, and let $P_i\to X_i$ ($i=1,2$) and $X_3\to I$ be qis with $X_i\in\widetilde{\mc P}_i$ and $I\in\oo K_{\oo{hi}}(\C_3)$ (such exist). Then we have 
$$
LG(X_1,X_2)\simeq G(P_1,P_2),
$$
$$
RF_1(X_2,X_3)\simeq F_1(P_2,I),\quad 
RF_2(X_1,X_3)\simeq F_2(P_1,I).
$$
\end{rk}
Note that (14.4.6) follows from Corollary~\ref{1432} p.~\pageref{1432}, Remark \ref{1448} and (14.4.7), and (14.4.5) follows from (14.4.6) by Theorem 13.4.1 p.~337.
\end{s}
\end{comment}
%
%%
