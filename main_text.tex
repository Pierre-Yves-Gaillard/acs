% about "categories and sheaves" (version ahe)
...
\ee
Indeed, the proof of \pr\ 2.7.5 p.~64 implies $(\widehat FB)(X)\simeq\co\alpha_X$ where $\alpha_X:\C^X\to\Set$ is the constant functor equal to $\{\text{pt}\}$, Corollary 2.4.4 (iii) p.~55 (see Proposition~\ref{244} p.~\pageref{244}) entails $\co\alpha_X\simeq\pi_0(\C^X)$, and the isomorphism $\pi_0(\C^X)\simeq A(X)$ is easily checked. 
...
\n$\bu$ P. 413, proof of Lemma 17.2.5 (iii). See \eqref{1725} p.~\pageref{1725}.
