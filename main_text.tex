...
%
\bc\label{revol}
In this text we adopt the following convention: If $f:X\to Y$ is a morphism of presites, then $f^t$ denotes the functor from $(\C_Y)^{\op}$ to $(\C_X)^{\op}$ (and {\em not} the functor from $\C_Y$ to $\C_X$) which defines $f$.
\ec
%
%%
%
