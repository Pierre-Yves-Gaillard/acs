% about "categories and sheaves" (version aih)
...
\n$\bu$ P.~159, Definition 7.3.1 (ii). The following conditions on the right localization $(\C_{\cc S},Q)$ of $\C$: 
...
%\n$\bu$ P.~160, \pr\ 7.3.2. \begin{rk}\label{732}Under the assumptions of \pr\ 7.3.2, the right localization $(\C_{\cc S},Q)$ of $\C$ is universal in the sense of Definition~\ref{url}.\end{rk}
%
