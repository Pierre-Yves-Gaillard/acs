% about "categories and sheaves" (version amp)
...
$$
\end{rk}
Note that (14.4.6) follows from Corollary~\ref{1432} p.~\pageref{1432} and Remark \ref{1448}, and (14.4.5) follows from (14.4.6) by Theorem 13.4.1 p.~337.
\end{s}
