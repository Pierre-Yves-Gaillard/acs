% about "categories and sheaves" (version ajb)
...
\begin{cm}\label{1341}
P. 337, Theorem 13.4.1. ``Let $\C$ be an abelian category'' should be ``Let $\C$ be an abelian category admitting countable products'', and  ``right localizable'' should be ``universally right localizable, and let $\oo R\Hom_\C(X,Y)$ denote its right localization at $(X,Y)$''.
\end{cm}
...
%
\bc%\label{1441}
P. 358, Lemma 14.4.1. Being unable to solve Part (iii) of Exercise 8.37 p.~211, I shall mentally replace ``direct sum'' with ``inductive limits'' in Assumption (14.4.1) p.~358.
\ec
%
%%
%
\bc%\label{1441}
P. 361, proof of Corollary 14.4.6 (ii). As I don't understand why there is an epimorphism $P_i\epi\alpha(i)$, I shall mentally add the assumption that $\cc P$ is generating.
\ec
%
