...
\n$\bu$ P.~162, proof of (7.4.3). Recall that $\SSS$ is a right multiplicative system in $\C$. We have the (non-commutative) diagram
$$
\begin{tikzcd}
...
Z^0\ar{rr}&&Z^1\ar{rr}&&Z^2\ar{rr}{e}&&TZ^0,
\end{tikzcd}
$$
...
Z^0\ar{r}\ar{d}[swap]{h}&Z^1\ar{d}\ar{r}&Z^2\ar{d}{k}\ar{r}{e}&TZ^0\ar{d}{-Th}\\ 
TX^0\ar{r}[swap]{Tu}&TX^1\ar{r}[swap]{Tv}&TX^2\ar{r}[swap]{-Tw}&T^2X^0
\end{tikzcd}
\end{equation}
%
...
The commutativity of (\ref{v3})6, (\ref{v1})3, and (\ref{v2})3 implies the anti-commutativity of (\ref{v4})9. 
