% about "categories and sheaves" (version alz)
...
\noindent P.~237: ``Proposition 9.6.3'' should be ``Theorem 9.6.3'' (twice). Proof of Corollary 9.6.6, first display: ``$\psi:\C\to\C$'' should be ``$\psi:\C\to\mathcal I_{inj}$''. %(By the way, I find the notation $\mathcal I_{inj}$ surprising: I would have expected either $\mathcal I$ or $\C_{inj}$.) 
...
\end{s}
%
\noindent P. 424, proof of Theorem 17.5.2 (iv). ``The functor $f^\dagger$ is left exact'' should be ``The functor $f^\dagger$ is exact''.
...
%%
%
%\noindent$\bu$ P. 52, Theorem 2.3.3 (i). Let us observe:\begin{rk}\label{233ib}In the setting of Theorem 2.3.3 (i), assume that $\varphi$ induces a bijection $\Ob(J)\to\Ob(I)$ and that there is a functor $\beta':I\to\C$ such that $\beta'\circ\varphi\simeq\beta$. Then $\varphi^\dagger\beta$ exists and is canonically isomorphic to $\beta'$.\end{rk}
%
%%
%
...
\end{prop}
%
\noindent{\em First proof.} Denote respectively by $L$ and $M$ the left and right-hand side of (\ref{241}), let 
$$
...
\end{prop}
%
\noindent{\em Proof}. By enlarging $\U$ we can assume that $\C'$ is a $\U$-category. Let $X'$ be in $\C'$. We know 
$$
...
\noindent{\em(a)} there is a small full subcategory $\B$ of $\C$ such that $\A\subset\B\subset \C$ and that $\A$ is closed by finite inductive limit, 
...
$$ 
\varphi:N\{L,G_L,(\alpha_\ell)\}\to(\C/G(a))^{L_a} 
$$ 
by 
$$
...
$$ 
N\{K,G,(\alpha_k)\}\sim M\left[N\{L,G_L,(\alpha_\ell)\}\xrightarrow{\varphi}(\C/G(a))^{L_a}\xleftarrow{\ \Delta\circ\widetilde{\alpha_a}}I_a\right]. 
$$ 
...
It follows from Proposition 2.6.3 (ii) p.~61 that $\widetilde{\alpha_a}$ is cofinal. By assumption $\C/G(a)$ is filtrant, and it is easy to see that this implies that $\Delta$ is cofinal. Thus, $\Delta\circ\widetilde{\alpha_a}$ is cofinal.
...
\noindent P. 365. I think the authors forgot to write down the beautiful formula 
\begin{align*}
