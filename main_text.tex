...
\n$\bu$ P.~191, proof of Theorem 8.5.8 (iii). Recall the statement: 
%
...
\end{lem}
%
Here is a slight rewording of the proof. 
...
\n$\bu$ P.~191, Step (a) of the proof of Theorem 8.5.8 (iv). Recall the statement: 
%
\begin{lem}%\label{858iv}
%
...
\end{lem}
%
Here is a slightly different wording of the argument. 
