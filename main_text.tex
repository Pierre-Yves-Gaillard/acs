% about "categories and sheaves" (version aqb)
...
$$
\begin{tikzcd}
X\ar[two heads]{d}\ar[two heads]{r}{u}&I'_f\ar[two heads]{d}{a}\ar{r}{v}&Y\\
I'_{a\circ u}\ar{ur}{c}\ar[two heads]{r}[swap]{b}&I'_v.\ar{ru}
\end{tikzcd}
$$ 
