% about "categories and sheaves" (version ais)
...
\bc\label{732} P.~160, \pr\ 7.3.2. If, in the setting of \pr\ 7.3.2, any $t$ in $\cc T$ is an isomorphism, then the right localization $(\C_{\cc S},Q)$ of $\C$ is universal in the sense of Definition~\ref{url}.
\ec 
