% about "categories and sheaves" (version ant)
...
\noindent$\bu$ the morphisms$f_i:=c_{\{i\}}\circ c_{i,\{i\}}:\alpha_i\to B$ induce a morphism $f:A\to B$, 

\noindent$\bu$ the morphisms $g_{i,J}:=c_i:\alpha_i\to A$ (with $i\in J$) induce a morphism $g_J:\beta_J\to A$, 
