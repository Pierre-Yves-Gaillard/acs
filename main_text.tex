...
%\n$\bu$ P. 140, Corollary 6.3.2. For the uniqueness up to unique isomorphism, see Subsection~\ref{su271} p.~\pageref{su271}. One could mention explicitly the formula \begin{equation}\label{140}(JF)(``\coli"\ \alpha)\simeq\coli\ F\circ\alpha.\end{equation}
