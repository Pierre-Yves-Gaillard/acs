% about "categories and sheaves" (version aqs)
...
\nn$\bu$ Definition of the morphism $A_1\times A_2\to A$\footnote{I don't think the part from here up to the end of Section~\ref{6112} is entirely correct. I'm working on it...}: Recall 
$$
A_1\times A_2\simeq\ic_{x_1,x_2}\ (X_1,X_2). 
$$ 
Let $x_i$ be in $A_i(X_i)$ for $i=1,2$. %We shall define $x\in A(X_1,X_2)$. 
We have 
$$
...
$$
\begin{tikzcd}
A_1\times A_2\simeq\displaystyle\ic_{x_1,x_2}(X_1,X_2)\ar{r}&\displaystyle\ic_y(Y_1,Y_2)\simeq A\\ 
(X_1,X_2)\ar{u}{(x_1,x_2)}\ar{r}[swap]{(f_1,f_2)}&(Y_1,Y_2),\ar{u}[swap]{y}
\end{tikzcd}
$$ 
and we leave it to the reader to check that this diagram does define the indicated morphism.
%
