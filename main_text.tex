% about "categories and sheaves" (version aos)
...
\begin{s}\label{1341}
P. 337, Theorem 13.4.1. ``Let $\C$ be an abelian category'' should be ``Let $\C$ be an abelian category admitting countable products'', and ``right localizable'' should be ``universally right localizable, and let $\oo{RHom}_\C$ denote its right localization''.
\end{s}
