% about "categories and sheaves" (version agr)
...
This is a work in progress. So far, there are comments only about the first ten chapters. I'm planning to read the whole book, but I'm progressing very slowly. The last section of this text is titled {\em Next Additions} and contains the last things I have written. When this last section contains enough pages (say, between ten and fifteen), I incorporate it into the main text. The hope is to help the interested reader follow the progression of this work. 
