% about "categories and sheaves" (version aqq)
...
\nn$\bu$ Definition of the morphism $A_1\times A_2\to A$: Recall 
$$
...
(X_1,X_2)\ar{u}{q(x_1,x_2)}\ar{r}[swap]{(f_1,f_2)}&(Y_1,Y_2),\ar{u}[swap]{p(y)}
\end{tikzcd}
$$ 
where the notation is, we hope, self-explanatory, and we leave it to the reader to check that this diagram does define the indicated morphism.
%
