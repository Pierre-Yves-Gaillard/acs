% about "categories and sheaves" (version ale)
...
\end{prop}
%
\n{\em Proof.} The functor $\Phi$ being fully faithful by Proposition 8.2.12, it suffices to prove that 
$$
\oo{Ob}(\Phi):\oo{Ob}(\oo P(\C,\Mod(\mathbb Z)))\to\oo{Ob}(\oo P(\C,\Set))
$$ 
is bijective. The map is surjective by Proposition 8.2.13, and it is injective by Lemma 8.2.11. q.e.d.
