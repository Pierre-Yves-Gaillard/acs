% about "categories and sheaves" (version aif)
...
\n$\bu$ P.~159, Definition 7.3.1 (ii). 
%
\begin{rk}\label{731ii}
If $\id_\C$ is universally right localizable, then any functor $F:\C\to\A$ is universally right localizable and satisfies $R_{\cc S}F\simeq F\circ R_{\cc S}\id_\C$. 
\end{rk}
...
\n(iii) the functor $Q:\oo K_c(\A)\to\oo D_c(\A)$ admits a right adjoint $R_q:\oo D_c(\A)\to\oo K_c(\A)$, this right adjoint is triangulated, satisfies $Q\circ R_q\simeq\id_{\oo D_c(\A)}$, and is the composition of $\iota:\oo K_{c,\oo{hi}}(\A)\to\oo K_c(\A)$ and a quasi-inverse of $Q\circ\iota$,

\n(iv) any functor $F:\oo K_c(\C)\to\cc D$ is universally right localizable and admits $F\circ R_q$ as a right localization (of course, $F\circ R_q$ is triangulated if $\cc D$ and $F$ are).

(See Remark \ref{731ii}.)
