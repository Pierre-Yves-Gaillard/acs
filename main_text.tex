% about "categories and sheaves" (version akf)
...
%%
%
\bc P.~81, proof of Proposition 3.3.2. Here is a minor variation of the proof. Recall the statement: 
%
\begin{prop} 
%
...
%%
%
\bc P. 401, Step (i) of the proof of Proposition 16.3.3. See \eqref{1623} p.~\pageref{1623} and \eqref{1625} p.~\pageref{1625}. (As already mentioned, $B''\to B$ should be $B''\to B'$.)
\ec
%
%%
%
...
%%
%
\bc\label{revol2} P. 407. Thanks to the convention in \S\ref{revol}, Formula (17.1.3) follows from (2.3.6) p.~52 of the book. For the sake of completeness, let us rewrite Formulas (17.1.3) and (17.1.4):
\be\label{17.1.3}
